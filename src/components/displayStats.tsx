  ...
  */
  ...
  return(
    <div className="stats">
      ...
      <div className="row">
        <div className="col-sm-6"><h4><span> Per Hour:</span> {addcomma(formatNumber(props.autoIncrement*3600))}</h4></div>
      <div className="col-sm-6"> <p><span>Refill Rate :</span> {props.refillRate}/s</p></div>
      </div>
    </div>
  )
}